...
function PrivacyPolicy() {
	return (
		<div className='privacy-policy'>
			<b>PRIVACY NOTICE</b>
			<br /> Last updated February 18, 2023
			<br /> This privacy notice
			<br />
			for MindMateAI ("Company," "we," "us," or "our"), describes how and
			<br />
			why we might collect, store, use, and/or share ("process") your
			<br />
			information when you use our services ("Services"), such as when
			<br />
			you: Visit our website at https://mindmate-ai.web.app/, or any
			website of ours that
			<br />
			...
			<br />
			cadenmarinozzi@gmail.com. <b>SUMMARY OF KEY POINTS</b> This summary
			<br />
			provides key points from our privacy notice, but you can find out
			<br />
			more details about any of these topics by clicking the link
			<br />
			...
			<br />
			directly to our table of contents. What personal information do we
			<br />
			...
			<br />
			MindMateAI and the Services, the choices you make, and the products
			<br />
			and features you use. Click here to learn more. Do we process any
			<br />
			...
			<br />
			situations and with specific third parties. Click here to learn
			<br />
			more. How do we keep your information safe? We have organizational
			<br />
			...
			<br />
			your personal information. Click here to learn more. How do you
			<br />
			...
			<br />
			MindMateAI does with any information we collect? Click here to
			review
			<br />
			the notice in full. <b>TABLE OF CONTENTS</b>{' '}
			<b>
			...
			<b>1. WHAT INFORMATION DO WE COLLECT?</b> Personal
			<br />
			information you disclose to us In Short: We collect personal
			<br />
			information that you provide to us. We collect personal information
			<br />
			that you voluntarily provide to us when you express an interest in
			<br />
			obtaining information about us or our products and Services, when
			<br />
			you participate in activities on the Services, or otherwise when you
			<br />
			contact us. Sensitive Information. We do not process sensitive
			<br />
			...
			<br />
			information we collect includes: Log and Usage Data. Log and usage
			<br />
			...
			<br />
			identify usage trends. We may process information about how you use
			<br />
			...
			<br />
			following situations: Business Transfers. We may share or transfer
			<br />
			your information in connection with, or during negotiations of, any
			<br />
			merger, sale of company assets, financing, or acquisition of all or
			<br />a portion of our business to another company.{' '}
			<b>
				4. DO WE USE COOKIES
				<br />
			...
			<br />
			other legal requirements). When we have no ongoing legitimate
			<br />
			business need to process your personal information, we will either
			<br />
			delete or anonymize such information, or, if this is not possible
			<br />
			...
			<b>6. HOW DO WE KEEP YOUR INFORMATION SAFE?</b> In
			<br />
			...
			<br />
			at any time. If you are located in the EEA or UK and you believe we
			<br />
			...
			<b>8. CONTROLS FOR DO-NOT-TRACK FEATURES</b> Most
			<br />
			...
			<br />
			backups, etc.). <b>10. DO WE MAKE UPDATES TO THIS NOTICE?</b> In
			Short:
			<br />
			...
			<br />
			you may email us at cadenmarinozzi@gmail.com or by post to:
			MindMateAI
			<br />
			...
			<br />
			your personal information, please visit: __________.
		</div>
	);
}
